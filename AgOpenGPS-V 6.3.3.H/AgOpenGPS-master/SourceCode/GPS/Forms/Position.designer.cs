...
namespace AgOpenGPS
{
    public partial class FormGPS
    {
        ...
        public double distancePivotToTurnCircle = -2222;
        ...
        public void SC_DeleteLinebyHand()
        {
            ...
            int found = -1;
            int i = 0;
            // search in not saved list
            if (triStrip[0].patchList.Count > 0)
            {
                //for each patch, write out the list of triangles to the file
                foreach (var triList in triStrip[0].patchList)
                {
