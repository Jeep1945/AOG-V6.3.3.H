...
namespace AgOpenGPS
{
    ...
    public partial class FormGPS
    {
        ...
        public bool isUTurnAlwaysOn, isCompassOn, isSpeedoOn, isSideGuideLines = true, isLineNumberon = true;
        ...
        private void tmrWatchdog_tick(object sender, EventArgs e)
        {
            ...
            if (fourSecondCounter >= 3)
            {
                ...
                if (isJobStarted)
                {
                    ...
                    lblCurrentField.Text = "Field: " + displayFieldName + "  -  " + vehicleFileName;

                    //lblCurveLineName.Text = lblGuidanceLine.Text;
                    if (trk.idx > -1)
                        lblCurveLineName.Text = "Line: " + trk.gArr[trk.idx].name;
                    else
                        lblCurveLineName.Text = "Line: " + gStr.gsNoGuidanceLines;
                }
                else
                {
                    lblCurrentField.Text = " No Field ";
                    lblFieldStatus.Text = "           ";
                }
            }
            /////////////////////////////////////////////////////////   2 second  ////////////////////////////////////////
        ...
        public void LoadSettings()
        {
            ...
            GuidanceLine9 = Properties.Settings.Default.setMenu_GuidanceLine9;
