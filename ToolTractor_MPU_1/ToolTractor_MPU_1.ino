String VERS = "Version ToolTractor_MPU_1 15.03.2025";
//
...
int AntDistance = 133;       // distance between the two antennas in cm,+,
int tractorhight = 260;   // roll is in Position calculated,
